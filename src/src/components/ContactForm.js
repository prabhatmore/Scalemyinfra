  ...
  return (
    <form className="contact-form" onSubmit={handleSubmit}>
      ...
      >
        ...
        <option value="Lift & Shift Migration">Lift & Shift Migration</option>
        <option value="Cost Optimization">Cost Optimization</option>
        <option value="Cloud Setup & Support">Cloud Setup & Support</option>
        <option value="Azure Virtual Desktop (AVD)">Azure Virtual Desktop (AVD)</option>
        <option value="Licensing">Licensing</option>
        <option value="Backup & Disaster Recovery">Backup & Disaster Recovery</option>
        <option value="Email & Microsoft 365 Migration">Email & Microsoft 365 Migration</option>
        <option value="24*7 Support Service">24*7 Support Service</option>
      </select>
